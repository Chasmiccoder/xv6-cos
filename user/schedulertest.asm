...
int main() {
  ...
  42:	82250513          	addi	a0,a0,-2014 # 860 <malloc+0xec>
  ...
  70:	2ca080e7          	jalr	714(ra) # 336 <exit>
            sleep(200); // IO bound processes
  74:	0c800513          	li	a0,200
  78:	00000097          	auipc	ra,0x0
  7c:	34e080e7          	jalr	846(ra) # 3c6 <sleep>
  ...
  94:	346080e7          	jalr	838(ra) # 3d6 <waitx>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 426:	46650513          	addi	a0,a0,1126 # 888 <digits>
 42a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4f2:	39ab8b93          	addi	s7,s7,922 # 888 <digits>
 ...
 632:	25290913          	addi	s2,s2,594 # 880 <malloc+0x10c>
        while(*s != 0){
