...
int main(int argc, char **argv) {
  ...
  36:	83e50513          	addi	a0,a0,-1986 # 870 <malloc+0xfc>
  ...
  50:	81450513          	addi	a0,a0,-2028 # 860 <malloc+0xec>
  ...
  88:	352080e7          	jalr	850(ra) # 3d6 <waitx>
        printf("\nWaiting: %d\nrunning: %d\n", wtime, rtime);
  8c:	fd842603          	lw	a2,-40(s0)
  90:	fdc42583          	lw	a1,-36(s0)
  94:	00000517          	auipc	a0,0x0
  98:	7ec50513          	addi	a0,a0,2028 # 880 <malloc+0x10c>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 426:	48650513          	addi	a0,a0,1158 # 8a8 <digits>
 42a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4f2:	3bab8b93          	addi	s7,s7,954 # 8a8 <digits>
 ...
 632:	27290913          	addi	s2,s2,626 # 8a0 <malloc+0x12c>
        while(*s != 0){
